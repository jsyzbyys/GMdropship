            ...
            <ul class="nav ace-nav pull-right">
                ...
                <li class="light-blue user-profile">
                    <a class="user-menu dropdown-toggle" href="javascript:;" data-toggle="dropdown">
                        ...
                        <span id="user_info"><small>Welcome</small> ${sessionScope.mvo.mvoname} </span>
...
<div id="sidebar">
    ...
    <ul class="nav nav-list">
        ...
        <li>
            ...
            <a href="bvo/preinfo" target="menuFrame">
        ...
        <li>
            ...
            <a href="store/check" class="dropdown-toggle" target="menuFrame">
        ...
        <li>
            ...
            <a href="product/list" target="menuFrame">
        ...
        <li>
            ...
            <a href="wish/list" target="menuFrame">
        ...
        <li>
            ...
            <a href="order/list" target="menuFrame">
...
<iframe id="menuFrame" name="menuFrame" src="bvo/preinfo" frameborder="no" width="100%" height="100%">
</iframe>
</body>
